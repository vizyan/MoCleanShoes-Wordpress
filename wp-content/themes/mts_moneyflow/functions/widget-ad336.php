...
/*-----------------------------------------------------------------------------------
	...
	Plugin Name: MyThemeShop 336x280 Ad Widget
	Description: A widget for 336x280 ad (Single banner)
	Version: 1.0
...
// load widget
add_action( 'widgets_init', 'mts_ad_336_widgets' );

// Register widget
function mts_ad_336_widgets() {
	register_widget( 'mts_ad_336_Widget' );
}

// Widget class
class mts_ad_336_widget extends WP_Widget {
...
function __construct() {
	...
	// Widget settings
	$widget_ops = array(
		'classname' => 'mts_ad_336_widget',
		'description' => __('A widget for 336x280 ad (Single banner)', 'mythemeshop')
	);
	...
	$control_ops = array(
		'width' => 336,
		'height' => 280,
		'id_base' => 'mts_ad_336_widget'
	);

	// Create the widget
	parent::__construct( 'mts_ad_336_widget', __('MyThemeShop: 336x280 Ad', 'mythemeshop'), $widget_ops, $control_ops );
...
function widget( $args, $instance ) {
	...
	// Display Ad
	if ( $link )
		echo '<a href="' . esc_url( $link ) . '"><img src="' . esc_attr( $ad ) . '" width="336" height="280" alt="" /></a>';
		
	elseif ( $ad )
	 	echo '<img src="' . esc_attr( $ad ) . '" width="336" height="280" alt="" />';
...
function form( $instance ) {
	...
	$defaults = array(
		'title' => '',
		'ad' => get_template_directory_uri()."/images/336x280.png",
