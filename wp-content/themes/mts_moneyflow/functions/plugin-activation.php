        ...
        public function register( $plugin ) {
            ...
            if ( ! empty( $plugin['alt'] ) ) {
                $args = array_merge( $plugin, array(
                    ...
                    'source' => __( 'MyThemeShop', 'mythemeshop' ),
...
function mts_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'description' => __( 'A simple and easy way to update your MyThemeShop themes and plugins to the the latest versions using good old one click method!', 'mythemeshop' ),
            'required'  => false,
        ...
        array(
            ...
            'alt_description' => __( 'WP Tab Widget Pro is the most powerful plugin for showing recommended content on blog posts to increase engagement and keep visitors on your site purpose.', 'mythemeshop' ),
        ...
        array(
            ...
            'alt_description' => __( 'WP Notification Bar is a custom notification and alert bar plugin for WordPress which is perfect for marketing promotions, alerts, increasing click throughs to other pages and so much more.', 'mythemeshop' ),
        ...
        array(
            ...
            'alt_description' => __( 'WP Quiz is a completely FREE quiz plugin that will let you create endlessly customizable and highly professional quizzes for your WordPress site.', 'mythemeshop' ),
        ...
        <ul class="mts-addons-tabs">
            ...
            <li class="mts-addons-tabs-li<?php if( 'recommended' == $tab ) echo' active'; ?>">
                <a href="<?php echo esc_url( $recommended_url ); ?>" class="mts-addons-tabs-link">
                    <?php _e( 'Recommended', 'mythemeshop' ) ?>
                </a>
            </li>
        </ul>
    </div>
        ...
        <form id="plugin-filter" action="" method="post">
            ...
            <div class="wrap mts-addons ">
                ...
                <header class="mts-addons-header">
                    ...
                    <p><?php printf( __( 'MyThemeShop and third party plugins recommended for %s theme!', 'mythemeshop' ), '<a href="'.esc_url( $theme_uri ).'"><strong>'.$theme_name.'</strong></a>' ); ?></p>
                </header>
                    ...
                    foreach ( $plugins as $plugin ) :
                        ...
                        if ( $tgma_instance->is_plugin_installed( $plugin['slug'] ) ) {
                            ...
                            if ( false !== $tgma_instance->does_plugin_have_update( $plugin['slug'] ) && $tgma_instance->can_plugin_update( $plugin['slug'] ) ) {
                                $update_button = '<a class="update-now-alt button" href="" data-slug="'.esc_attr( $plugin['slug'] ).'" data-plugin="'.esc_attr( $plugin['file_path'] ).'" aria-label="" data-name="' . esc_attr( $plugin['name'] ) . '">'.__('Update Now', 'mythemeshop' ).'</a>';
                            }
