...
class mts_popular_posts_widget extends WP_Widget {
	...
	public function get_popular_posts( $qty, $title_length, $comment_num, $date, $days, $show_thumb3, $box_layout, $show_excerpt, $excerpt_length ) {
		...
		if ( 'horizontal-small' === $box_layout ) {
			$thumb = array( 'width' => 66, 'height' => 55, 'crop' => true );
			...
			$thumb = array( 'width' => 330, 'height' => 220, 'crop' => true );
					...
					<div class="post-img">
						<a rel="nofollow" href="<?php echo esc_url( get_the_permalink() ); ?>" title="<?php echo esc_attr( get_the_title() ); ?>">
							<?php if(has_post_thumbnail()) {
		                    	...
		                    	echo '<div class="featured-thumbnail single-featured"><img src="'.get_template_directory_uri().'/images/nothumb-widgetthumb.png" width="'.$thumb['width'].'" height="'.$thumb['height'].'"></div>';
		                    } ?>
						</a>
					</div>
				<?php endif; ?>
					...
					<div class="post-data-container">
						...
						<div class="post-info">
							...
							<?php if ( $comment_num == 1 ) : ?>
								 &bull;
							<span class="thecomment">  <?php echo comments_number(__('No Comment','mythemeshop'), __('1 Comment','mythemeshop'), '<span class="comm">%</span> '.__('Comments','mythemeshop'));?></span>
							<?php endif; ?>
						</div> <!--.post-info-->
						<?php endif; ?>
